...
st.set_page_config(page_title="Asisten Promo Kasir AZKO", page_icon="🤖")
...
instruksi = (
    ...
    + promo_text +
    "\n\nGunakan bahasa sopan, singkat, dan jelas. "
    "Jika di luar topik promo, balas: 'Maaf, saya hanya bisa memberikan informasi promo saat ini.'"
)

model = genai.GenerativeModel("models/gemini-flash-latest", system_instruction=instruksi)
